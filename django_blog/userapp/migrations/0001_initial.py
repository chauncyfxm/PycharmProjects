# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-06-06 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='userapp.BlogCategory', verbose_name='博客分类')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(to='userapp.Tags', verbose_name='标签'),
        ),
        migrations.AddField(
            model_name='post',
            name='user',
        ...
        migrations.AddField(
            model_name='comment',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userapp.Post', verbose_name='博客'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
